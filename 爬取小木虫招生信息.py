...
infos = []
for i in range(1, 5):
    urls.append("http://muchong.com/bbs/kaoyan.php?formhash=845e5c4d&r1%5B0%5D=08&r2%5B0%5D=0812&r3%5B0%5D=&year=2020&type=1&oksubmit=%C8%B7%B6%A8&page={}".format(i))
